...
func LoadYaml(filename string, val any) error { return conf.LoadYaml(filename, val) }
...
func LoadJson(filename string, val any) error { return conf.LoadJson(filename, val) }
...
func LoadToml(filename string, val any) error { return conf.LoadToml(filename, val) }
